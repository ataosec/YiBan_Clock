...
class user():
    ...
    def login(self):
        ...
        login_data = {"password": self.passwd,"mobile": self.mobile, "ct": "2", "identify": "123213133"}
    ...
    def yesterday_task(self):
        url_1 = "https://api.uyiban.com:443/officeTask/client/index/completedList?StartTime={}&EndTime={}&CSRF={}".format(T.Starttime, T.EndTime, self.CSRF)
